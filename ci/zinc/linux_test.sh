...
stage3/bin/zig build test-std            -fqemu -fwasmtime -Denable-llvm -Dskip-release
...
# TODO remove -Dskip-release above and then this line can be deleted
$STAGE1_ZIG build test-std              -fqemu -fwasmtime
